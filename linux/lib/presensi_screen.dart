...
class _PresensiScreenState extends State<PresensiScreen> {
  int _selectedDateIndex = 4; // JUM 24 = index 4
  String _searchQuery = '';
  int _selectedNavIndex = 1; // Presensi tab

  // Avatar background colors for each student
  final List<Color> _avatarColors = [
    const Color(0xFF94A3B8), // slate
    const Color(0xFF6EE7B7), // teal/green
  ...
  Map<String, int> get _summary {
    int hadir = _students.where((s) => s['status'] == 'Hadir').length;
    int izin  = _students.where((s) => s['status'] == 'Izin').length;
    int sakit = _students.where((s) => s['status'] == 'Sakit').length;
    int alpa  = _students.where((s) => s['status'] == 'Alpa').length;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.notifications_outlined, color: Color(0xFF4B5563), size: 26),
            onPressed: () {},
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    // Find original index for consistent left border
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      ...
                      backgroundColor: Color(0xFF535763),
                    ),
                  );
                },
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: leftBorderColor != null
                ...
                : null,
            borderRadius: leftBorderColor != null ? null : BorderRadius.circular(10),
          ),
          child: Column(
            children: [
              Text(
  ...
  Widget _buildStudentCard(Map<String, dynamic> student, int originalIndex) {
    final bool isHighlighted = originalIndex == 1; // 2nd student has left border
      ...
      child: ClipRRect(
        ...
        child: IntrinsicHeight(
          child: Row(
            ...
            children: [
              // Left color border for 2nd student
              if (isHighlighted)
                Container(
                  width: 4,
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          // Check mark if already has a status
                          if (isCompleted)
                            Icon(
  ...
  // ─── Status Button ───────────────────────────────────────────────────────────
  Widget _statusBtn(String label, Map<String, dynamic> student, String value) {
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isActive ? const Color(0xFF535763) : const Color(0xFFF3F4F6),
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _navItemActive(Icons.fingerprint, 'Presensi', 1),
      ...
      child: Column(
        ...
        children: [
          Icon(
            icon,
            size: 24,
            color: selected ? const Color(0xFF4B5563) : const Color(0xFF9CA3AF),
          ),
          const SizedBox(height: 4),
          Text(
            label,
  ...
  Widget _navItemActive(IconData icon, String label, int index) {
    return GestureDetector(
